...
export function Sidebar({ className, children, ...props }: SidebarProps) {
  return (
    <div className={cn("flex h-full w-60 flex-col border-r bg-background", className)} {...props}>
      {children}
    </div>
  )
}
...
export function SidebarSeparator({ className, ...props }: SidebarSeparatorProps) {
  return <div className={cn("my-1 border-t", className)} {...props} />
}
...
export { SidebarProvider, SidebarTrigger, SidebarRail, SidebarInset, SidebarInput, useSidebar }
